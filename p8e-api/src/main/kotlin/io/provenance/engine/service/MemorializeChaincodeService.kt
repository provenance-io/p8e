...
@Service
class MemorializeChaincodeService(
    ...
    override fun handle(payload: Jobs.P8eJob) {
        ...
        // perform and wait for memorialize action to complete
        waitForTx {
            memorialize(affiliateAddress, osLocatorEstimate.fees)
        }

        // perform and wait for add data access to complete
        waitForTx {
